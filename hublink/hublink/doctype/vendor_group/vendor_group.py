...
class VendorGroup(NestedSet):
	...
	if TYPE_CHECKING:
		...
		parent_vendor_group: DF.Link | None
		payment_terms: DF.Link | None
		rgt: DF.Int
		vendor_group_name: DF.Data
	# end: auto-generated types

	nsm_parent_field = "parent_vendor_group"

	def validate(self):
		if not self.parent_vendor_group:
			self.parent_vendor_group = get_root_of("Vendor Group")
